...
<body>
    ...
    <section class="main padder">
	  ...
	  <div class="clearfix">
        <h4><i class="icon-table"></i>Pesquisar Atendentes</h4>
      </div>
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button class="btn btn-sm btn-white" type="submit" name="command" value="ListarAtendenteBuscar">Buscar</button>
							</span>
						</div>
					</div>
				</form>
					...
					<table class="table table-striped" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>${to.flagAtivo}</td>
							   ...
							   <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualizarAtendente&id=${to.codAtendente}">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarAtendente&id=${to.codAtendente}">Editar</a>
                                                <button id="btn${to.codAtendente}" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${to.codAtendente}">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
