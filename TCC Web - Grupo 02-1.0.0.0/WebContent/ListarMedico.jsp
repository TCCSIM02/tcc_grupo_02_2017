...
<body>
    ...
    <section class="main padder">
	  ...
	  <div class="clearfix">
        <h4><i class="icon-table"></i>Pesquisar Médicos</h4>
      </div>
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button class="btn btn-sm btn-white" type="submit" name="command" value="ListarMedicoBuscar">Buscar</button>
							</span>
						</div>
					</div>
				</form>
					...
					<table class="table table-striped" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>${to.flagAtivo}</td>
							   ...
							   <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualizarMedico&id=${to.codMedico}">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarMedico&id=${to.codMedico}">Editar</a>
                                                <button id="btn${to.codMedico}" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${to.codMedico}">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
