						...
						<form class="form-horizontal" action="controller.do" method="post" data-validate="parsley"> 
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="200" placeholder="Razão social" size="16" value="${unidadeTO.razaoSocial}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="150" placeholder="Nome fantasia" size="16" value="${unidadeTO.nomeFantasia}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="18" placeholder="CNPJ" size="16" value="${unidadeTO.cnpj}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="45" placeholder="Nome rede" size="16" value="${unidadeTO.nomeRede}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="200" placeholder="Endereço" size="16" value="${unidadeTO.endereco}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="50" placeholder="Cidade" size="16" value="${unidadeTO.cidade}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="2" placeholder="UF" size="16" value="${unidadeTO.uf}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="20" placeholder="País" size="16" value="${unidadeTO.pais}">
								</div>				  
							</div>
