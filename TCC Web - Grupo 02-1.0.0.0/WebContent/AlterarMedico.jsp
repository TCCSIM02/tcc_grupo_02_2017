						...
						<form class="form-horizontal" action="controller.do" method="post" data-validate="parsley"> 
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="15" placeholder="telefone principal" size="16"  value="${medicoTO.tel1}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="15" placeholder="telefone opcional" size="16"  value="${medicoTO.tel2}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="15" placeholder="telefone opcional" size="16" value="${medicoTO.cel}">
								</div>				  
