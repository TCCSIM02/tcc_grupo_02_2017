	...
	<html>
		...
		<section id="content">
			...
			<section class="main padder">
				...
				<div class="clearfix">
					<h4><i class="icon-edit"></i>Cadastrar Administrador</h4>
				</div>
					...
					<div class="col-sm-12">
						<section class="panel">
							<div class="panel-body">
								...
								<input type="hidden"  name="codNivel" id="codNivel" readonly="true" value="4">
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											maxlength="20" placeholder="Nome de usuário" size="16">
										</div>				  
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											maxlength="65" placeholder="Senha" size="16">
										</div>				  
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											maxlength="65" placeholder="Nome" size="16">
										</div>				  
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											maxlength="9" placeholder="Cidade" size="16" readonly="true">
										</div>				  
									</div>
									...
									<div class="form-group">
									  <div class="col-lg-9 col-lg-offset-3">                      
										...
										<button name="command" value="CriarAdministrador" type="submit" class="btn btn-primary">Cadastrar</button>
									  </div>
									</div>
