...
<body>
	...
	<section id="content">
		...
		<section class="main padder">
			...
			<div class="clearfix">
				<h4><i class="icon-edit"></i>Alterar atendentes</h4>
			</div>
				...
				<section class="panel">
					<div class="panel-body">
						...
						<form class="form-horizontal" action="controller.do" method="post" data-validate="parsley"> 
							...
							<input type="hidden" name="codAtendente" id="codAtendente" value="${atendenteTO.codAtendente}" /> 
		

							<div class="form-group">
								<label class="col-lg-3 control-label">Nome atendente</label>
								<div class="col-lg-6">
									<input type="text" class="form-control" name="nome" id="nome" required
									maxlength="65" placeholder="nome do atendente" size="16" value="${atendenteTO.nome}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="14" placeholder="cpf" size="16" value="${atendenteTO.cpf}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="11" placeholder="data de nascimento" size="16" value="${atendenteTO.dataNascimento}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="100" placeholder="email" size="16" value="${atendenteTO.email}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="20" placeholder="estado civil" size="16"  value="${atendenteTO.estadoCivil}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="35" placeholder="nacionalidade" size="16"  value="${atendenteTO.nacionalidade}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="9" placeholder="cep" size="16" value="${atendenteTO.cep}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="200" placeholder="endereco" size="16" readonly="true" value="${atendenteTO.endereco}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="9" placeholder="cep" size="16" readonly="true" value="${atendenteTO.cidade}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="20" placeholder="país" size="16" readonly="true" value="${atendenteTO.pais}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="2" placeholder="uf" size="16" readonly="true" value="${atendenteTO.uf}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="200" placeholder="número" size="16" value="${atendenteTO.numeroEndereco}">
								</div>				  
							</div>					
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="16" placeholder="telefone principal" size="16"  value="${atendenteTO.tel1}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="16" placeholder="telefone opcional" size="16"  value="${atendenteTO.tel2}">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="16" placeholder="telefone opcional" size="16" value="${atendenteTO.cel}">
								</div>				  
								
							<div class="form-group">
							  <div class="col-lg-9 col-lg-offset-3"> 
								<a href="ListarAtendente.jsp" class="btn btn-white">Cancelar</a>
								<button name="command" value="AlterarAtendente" type="submit" class="btn btn-primary">Salvar</button>
							  </div>
							</div>
