...
<body>
	...
	<c:import url="MenuAdministrador.jsp?pagina=promocao" />
			...
			<div id="list" class="row">
				...
				<div class="table-responsive col-md-12">
					<table class="table table-striped" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>${to.codPromocao}</td>
							<td>${to.valorPromocao}</td>
							<td>${to.dataInicio}</td>
							...
							<td>${to.dataCadastro}</td>
							   ...
							   <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualizarPromocao&id=${to.codPromocao}">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarPromocao&id=${to.codPromocao}">Editar</a>
                                                <button id="btn${to.codPromocao}" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${to.codPromocao}">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
