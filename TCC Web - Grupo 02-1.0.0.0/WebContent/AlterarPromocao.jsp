				...
				<section class="panel">
					<div class="panel-body">
						...
						<form class="form-horizontal" action="controller.do" method="post" data-validate="parsley"> 
							...
							<input type="hidden" name="codPromocao" id="codPromocao" value="${promocaoTO.codPromocao}" /> 
							...
							<div class="form-group">
							  <div class="col-lg-9 col-lg-offset-3"> 
								...
								<button name="command" value="AlterarPromocao" type="submit" class="btn btn-primary">Salvar</button>
							  </div>
							</div>
