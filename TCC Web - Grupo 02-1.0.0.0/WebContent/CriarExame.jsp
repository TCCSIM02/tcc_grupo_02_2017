...
<body>
	...
	<section id="content">
		...
		<section class="main padder">
			...
			<div class="clearfix">
				<h4><i class="icon-edit"></i>Cadastrar exame</h4>
			</div>
						...
						<form class="form-horizontal" action="controller.do" method="post" data-validate="parsley">      
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="500" placeholder="descrição do exame" size="16">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="100" placeholder="resultado do exame" size="16">
								</div>				  
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									...
									maxlength="45" placeholder="resultado do exame" size="16">
								</div>				  
							</div>						
							...
							<div class="form-group">
							  <div class="col-lg-9 col-lg-offset-3">                      
								...
								<button name="command" value="CriarExame" type="submit" class="btn btn-primary">Cadastrar</button>
							  </div>
							</div>
