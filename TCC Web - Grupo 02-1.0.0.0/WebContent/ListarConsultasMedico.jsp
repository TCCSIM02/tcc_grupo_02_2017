					...
					$('#fc-agendamento').fullCalendar(
							{
								...
								eventClick : function(calEvent, jsEvent, view) {
									...
									var codAgendamento = calEvent.codAgendamento;
									var codMedico = calEvent.codMedico;
									var codPaciente = calEvent.codPaciente;
									var pEventDate = dt.format().substring(0, 10);
									
									window.open(
											'controller.do?command=PreencheConsulta&eventDate='
													+ pEventDate+'&codAgendamento='+codAgendamento+'&codMedico='+codMedico+'&codPaciente='+codPaciente,
											"_self"); 
								},
