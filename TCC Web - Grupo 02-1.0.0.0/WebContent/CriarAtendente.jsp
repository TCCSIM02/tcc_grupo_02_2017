...
<html>
	...
	<section id="content">
		...
		<section class="main padder">
			...
			<div class="clearfix">
				<h4><i class="icon-edit"></i>Cadastrar atendente</h4>
			</div>
							...
							<input type="hidden"  name="codNivel" id="codNivel" readonly="true" value="3">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										...
										maxlength="65" placeholder="nome do atendente" size="16">
									</div>				  
								</div>
								...
								<div class="form-group">
								  <div class="col-lg-9 col-lg-offset-3">                      
									...
									<button name="command" value="CriarAtendente" type="submit" class="btn btn-primary">Cadastrar</button>
								  </div>
								</div>
